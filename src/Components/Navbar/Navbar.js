  ...
  return (
    ...
    <div className="container-fluid bg-light position-relative shadow">
        <nav className="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
            <Link className="navbar-brand font-weight-bold text-secondary" style={{ fontSize: 50 }} to="/"></Link>
            <a href="/" className="navbar-brand font-weight-bold text-secondary" style={{ fontSize: 50 }} img="public/assets/img/ToppersPreschoolLogo.png" alt="">
