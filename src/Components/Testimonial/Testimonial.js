            ...
            <div className="owl-carousel testimonial-carousel">
                <div className="testimonial-item px-3">
                    ...
                    <div className="d-flex align-items-center">
                        <img className="rounded-circle" src="assets/img/testimonial-1.jpg" style={{ width: 70, height: 70 }} alt="" />
                        <div className="pl-3">
                            <h5>Parent Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div className="testimonial-item px-3">
                    ...
                    <div className="d-flex align-items-center">
                        <img className="rounded-circle" src="assets/img/testimonial-2.jpg" style={{ width: 70, height: 70 }} alt="" />
                        <div className="pl-3">
                            <h5>Parent Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div className="testimonial-item px-3">
                    ...
                    <div className="d-flex align-items-center">
                        <img className="rounded-circle" src="assets/img/testimonial-3.jpg" style={{ width: 70, height: 70 }} alt="" />
                        <div className="pl-3">
                            <h5>Parent Name</h5>
                            <i>Profession</i>
                        </div>
                ...
                <div className="testimonial-item px-3">
                    ...
                    <div className="d-flex align-items-center">
                        <img className="rounded-circle" src="assets/img/testimonial-4.jpg" style={{ width: 70, height: 70 }} alt="" />
                        <div className="pl-3">
                            <h5>Parent Name</h5>
                            <i>Profession</i>
                        </div>
